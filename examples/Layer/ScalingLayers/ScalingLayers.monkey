...
Class cGame Extends App
	...
	Method OnCreate:Int()
		...
		' Now create a new layer on top of the default one and set its scissor.
		...
		' Fill the background with some tiled images
		For Local y:Int = 1 To 7
			For Local x:Int = 1 To 11
				Local im:=fE.CreateImage("Tile1.png",64*x, 64*y)
				im.SetHandle(0,0)
			Next
		Next
		
		fE.CreateLine(0,fE.GetCanvasHeight()/2,fE.GetCanvasWidth(),fE.GetCanvasHeight()/2)
		fE.CreateLine(fE.GetCanvasWidth()/2,0,fE.GetCanvasWidth()/2,fE.GetCanvasHeight())
		
		' Create another yellow and spinning oval 
		Local box2 := fE.CreateOval(fE.GetCanvasWidth()/4,fE.GetCanvasHeight()/8,fE.GetCanvasWidth()/2,fE.GetCanvasHeight()/2)
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText("FPS= "+fE.GetFPS(),fE.GetLocalX(40), fE.GetLocalY(10))
			fE.GetCanvas().DrawText("TouchX= "+fE.GetTouchX(), fE.GetLocalX(40), fE.GetLocalY(25))
			fE.GetCanvas().DrawText("TouchY= "+fE.GetTouchY(), fE.GetLocalX(40), fE.GetLocalY(40))
			fE.GetCanvas().DrawText("LayerScale= "+layer2.GetScale(), fE.GetLocalX(fE.GetCanvasWidth()-150), fE.GetLocalY(10))
			fE.GetCanvas().DrawText("Layer2X= "+layer2.GetPosX(), fE.GetLocalX(fE.GetCanvasWidth()-150), fE.GetLocalY(25))
			fE.GetCanvas().DrawText("Layer2Y= "+layer2.GetPosY(), fE.GetLocalX(fE.GetCanvasWidth()-150), fE.GetLocalY(40))
			fE.GetCanvas().DrawText("feScaleX= "+fE.scaleX, fE.GetLocalX(fE.GetCanvasWidth()-150), fE.GetLocalY(55))
			fE.GetCanvas().DrawText("feScaleY= "+fE.scaleY, fE.GetLocalX(fE.GetCanvasWidth()-150), fE.GetLocalY(70))

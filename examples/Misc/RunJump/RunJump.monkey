...
#rem
	...
	Description:	This fantomX sample script shows basics of run & jump game 
...
Class cGame Extends App
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText( "FPS= "+fE.GetFPS(),fE.GetLocalX(10), fE.GetLocalY(fE.GetCanvasHeight()-20))
	...
	Method OnObjectUpdate:Int(obj:ftObject)
		...
		If obj.GetID() = 0
			If obj.GetWidth() <= 0				'When health is less than or equal to zero
				...
				_g.fE.SetPaused(True)			'Pause game
			Endif		
		Endif

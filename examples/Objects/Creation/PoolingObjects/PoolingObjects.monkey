...
#rem
	Script:			PoolingObjects.monkey
	Description:	Sample script that shows how to use pooling with ftObjects
...
Class cGame Extends App
	...
	Method CreateBoxes:Void()
		...
		Local box := fE.CreateBox(10,40,Rnd(fE.GetCanvasWidth()),Rnd(fE.GetCanvasHeight()))
		box.SetSpin(1)
		box.CreateTimer(222, Rnd(500,2000))
	End
	'------------------------------------------
	Method OnCreate:Int()
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.SetColor(255,255,0)
			fE.GetCanvas().DrawText("ObjectCount= " + fE.GetObjCount(),fE.GetLocalX(10), fE.GetLocalY(20))
...
Class cEngine Extends ftEngine
	...
	Method OnObjectTimer:Int(timerId:Int, obj:ftObject)
		...
		obj.Remove()
		Self.CreateTimer(222, Rnd(500,2000))
		Return 0
	End	
	'------------------------------------------

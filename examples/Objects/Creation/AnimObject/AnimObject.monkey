...
Class cGame Extends App
	...
	Method OnCreate:Int()
		...
		' Store the width and height og the canvas
	...
	Method OnUpdate:Int()
		...
		' Depending of the key hit, change the animations
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText("Current animation name: " + player.GetAnimName(), fE.GetLocalX(20), fE.GetLocalY(20))
			fE.GetCanvas().DrawText("Current animation frame count: " + player.GetAnimCount() + " frames", fE.GetLocalX(20), fE.GetLocalY(40))
			fE.GetCanvas().DrawText("Current animation frame number: #" + Int(player.GetAnimFrame()), fE.GetLocalX(20), fE.GetLocalY(60))
			fE.GetCanvas().DrawText("Current animation time length: " + player.GetAnimTime(), fE.GetLocalX(20), fE.GetLocalY(80))
			If player.GetAnimPaused()=True
				fE.GetCanvas().DrawText("Animation paused!",fE.GetLocalX(20), fE.GetLocalY(fE.GetCanvasHeight()-40))
			Endif

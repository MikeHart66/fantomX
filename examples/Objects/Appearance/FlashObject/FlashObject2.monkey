	...
	Method OnObjectRender:Int(obj:ftObject)		'--obj1-- & --alpha1--
		...
		If o.frameOn = 1 Then
			If o.GetID() = 3 Then	'--obj1--
				Self.GetCanvas().DrawLine(px-55, py-55, px+55, py-55)	'Top       '(x1, y1, x2, y2)
				Self.GetCanvas().DrawLine(px-55, py+55, px+55, py+55)	'Bottom
				Self.GetCanvas().DrawLine(px-55, py-55, px-55, py+55)	'Left
				Self.GetCanvas().DrawLine(px+55, py-55, px+55, py+55)	'Right
			Endif
			
			If o.GetID() = 4 Then	'--alpha1--
				Self.GetCanvas().DrawCircle(px, py, 60)	'(x, y, radius)
				Self.SetColor(0,0,0)			'Black
				Self.GetCanvas().DrawCircle(px, py, 58)
				Self.SetColor(0,255,255)		'Aqua
				Self.GetCanvas().DrawCircle(px, py, 50)
			Endif
		Endif
		Return 0
	End

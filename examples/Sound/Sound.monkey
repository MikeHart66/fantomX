...
#rem
	Script:			Sound.monkey
	Description:	Sample script to show how to use sounds and mousic in fantomX
...
Class cGame Extends App
	...
	Method OnCreate:Int()
		...
		myMusic = fE.LoadMusic("happy.mp3")
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText( "Press the -S- key to hear a sound", fE.GetLocalX(10), fE.GetLocalY(30))
			fE.GetCanvas().DrawText( "Press the -P- key to (un)pause the music file", fE.GetLocalX(10), fE.GetLocalY(45))

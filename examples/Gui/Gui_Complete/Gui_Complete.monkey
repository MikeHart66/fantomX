	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			If guiChkBox.GetState() = True Then
				fE.GetCanvas().DrawText("Checked!",Int(fE.GetLocalX(guiChkBox.GetPosX())+guiChkBox.GetWidth()/2.0+10),Int(fE.GetLocalY(guiChkBox.GetPosY())))
			Else	
				fE.GetCanvas().DrawText("Unchecked.",fE.GetLocalX(guiChkBox.GetPosX()+guiChkBox.GetWidth()/2.0+10),fE.GetLocalY(guiChkBox.GetPosY()))
			Endif
			If guiSwitch.GetState() = True Then
				fE.GetCanvas().DrawText("ON",fE.GetLocalX(guiSwitch.GetPosX()),fE.GetLocalY(guiSwitch.GetPosY()+30))
			Else	
				fE.GetCanvas().DrawText("OFF",fE.GetLocalX(guiSwitch.GetPosX()),fE.GetLocalY(guiSwitch.GetPosY()+30))
			Endif
			If guiSwitch2.GetState() = True Then
				fE.GetCanvas().DrawText("ON",fE.GetLocalX(guiSwitch2.GetPosX()),fE.GetLocalY(guiSwitch2.GetPosY()+30))
			Else	
				fE.GetCanvas().DrawText("OFF",fE.GetLocalX(guiSwitch2.GetPosX()),fE.GetLocalY(guiSwitch2.GetPosY()+30))
			Endif
			
			fE.GetCanvas().DrawText(_g.guiStickR.GetJoyX(), fE.GetLocalX(20), fE.GetLocalY(fE.GetCanvasHeight()-30))

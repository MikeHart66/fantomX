...
#rem
	...
	Description:	fantomX sample script that shows how to use the custom gui slider object 
...
Class cGame Extends App
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText(slVal1, fE.GetLocalX(Int(guiSlider.GetPosX())), fE.GetLocalY(Int(guiSlider.GetPosY()-40)), 0.5, 0.0)
			fE.GetCanvas().DrawText(slVal2, fE.GetLocalX(Int(guiSlider2.GetPosX()-40)), fE.GetLocalY(Int(guiSlider2.GetPosY())), 0.0, 0.5)
			fE.RestoreAlpha()

...
#rem
	...
	Description:	fantomX sample script that shows how to use the custom gui joystick object 
...
Class cGame Extends App
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText(_g.guiStickL.GetJoyX(), fE.GetLocalX(20), fE.GetLocalY(fE.GetCanvasHeight()-40))
			fE.GetCanvas().DrawText(_g.guiStickL.GetJoyY(), fE.GetLocalX(20), fE.GetLocalY(fE.GetCanvasHeight()-30))
			fE.GetCanvas().DrawText(_g.guiStickR.GetJoyX(), fE.GetLocalX(fE.GetCanvasWidth()-40), fE.GetLocalY(fE.GetCanvasHeight()-40))
			fE.GetCanvas().DrawText(_g.guiStickR.GetJoyY(), fE.GetLocalX(fE.GetCanvasWidth()-40), fE.GetLocalY(fE.GetCanvasHeight()-30))

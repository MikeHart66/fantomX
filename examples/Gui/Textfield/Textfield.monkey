...
#rem
	...
	Description:	fantomX sample script that shows how to use the custom gui textfield object
...
Class cGame Extends App
	...
	Method OnRender:Int()
		...
		If fE.GetPaused() = False Then
			...
			fE.GetCanvas().DrawText( "FPS= "+fE.GetFPS(),fE.GetLocalX(20), fE.GetLocalY(10))
			fE.RestoreAlpha()
